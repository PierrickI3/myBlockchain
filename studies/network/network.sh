...
function networkUp() {
  ...
  infoln "Deploying orderers..."
  kubectl apply -f ../kubernetes/orderers

  # TODO Wait until orderers deployments are ready

  infoln "Deploying peers..."
  kubectl apply -f ../kubernetes/peers
...
function networkDown() {
  ...
  infoln "Deleting peers..."
  kubectl delete -f ../kubernetes/peers

  infoln "Deleting orderers..."
  kubectl delete -f ../kubernetes/orderers
